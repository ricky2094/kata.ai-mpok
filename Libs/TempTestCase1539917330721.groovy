...
RunConfiguration.setExecutionSettingFile('C:\\Users\\RICKY~1.NUG\\AppData\\Local\\Temp\\Katalon\\Test Cases\\test\\20181019_094850\\execution.properties')
...
WebUI.click(findTestObject('click_api'))

WebUI.setText(findTestObject('set text timezone'), 'gmt +7')

WebUI.sendKeys(findTestObject('set text timezone'), Keys.chord(Keys.ENTER))
